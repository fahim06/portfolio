...
import {engineeringValues, personalInfo, skills} from "@/data";
            ...
            <div className="flex flex-col md:flex-row gap-8 md:gap-12 lg:gap-16 items-center md:items-start">
                ...
                <div className="shrink-0 flex justify-center">
                    <div className="relative group">
                        ...
                        <div
                            className="absolute -inset-2 sm:-inset-3 md:-inset-4 bg-accent/5 rounded-xl sm:rounded-2xl -rotate-2 sm:-rotate-3 group-hover:rotate-0 transition-transform duration-300"/>
                        <div
                            className="absolute -inset-2 sm:-inset-3 md:-inset-4 bg-accent/5 rounded-xl sm:rounded-2xl rotate-2 sm:rotate-3 group-hover:rotate-0 transition-transform duration-300"/>
                        {/* Photo container - fully responsive */}
                        <div
                            className="relative w-48 h-60 xs:w-56 xs:h-72 sm:w-64 sm:h-80 md:w-56 md:h-72 lg:w-64 lg:h-80 xl:w-72 xl:h-96 rounded-xl sm:rounded-2xl overflow-hidden shadow-lg sm:shadow-xl border border-border sm:border-2">
                            <Image
