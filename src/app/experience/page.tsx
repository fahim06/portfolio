...
import { experience, education, ExperienceEntry, personalInfo } from "@/data";
...
function TimelineItem({ entry }: { entry: ExperienceEntry }) {
  return (
    <article className="relative pl-8 pb-12 last:pb-0">
      ...
      {/* Content */}
      <div className="bg-background border border-border rounded-xl p-6 hover:border-border-hover hover:shadow-md transition-all duration-300">
        {/* Header */}
